...
public class EldritchApplication extends Application {
    ...
    private void initializePerformanceSettings() {
        ...
        try {
            ...
            new Thread(() -> {
                try {
                    Class.forName("com.poquets.eldritch.CardDatabaseHelper");
                    Class.forName("com.poquets.eldritch.Card");
                    Class.forName("com.poquets.eldritch.Config");
                    Class.forName("com.poquets.eldritch.DecksManager");
                    Class.forName("com.poquets.eldritch.AsyncXMLProcessor");
